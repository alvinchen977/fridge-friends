...
class SearchRecipeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val searchButton: Button = findViewById(R.id.startSearch)
        val searchWords: TextView = findViewById(R.id.searchWords)
        searchButton.setOnClickListener {
//            if (searchWords.text == ""){
//                Log.e("error", "pls search something")
//            }
            val splitString : Array<String> = searchWords.text.toString().split(",").toTypedArray()
            RecipeStore.getSearchedRecipes(applicationContext, splitString){ it ->
...
//                        var tutorials: Array<Any> = Gson().fromJson(tut_actual, arrayTutorialType)
                ...
                listView = findViewById<ListView>(R.id.search_recipe_list_view)
